...
// --- RECHTLICHE TEXTE (gekürzt für Lesbarkeit) ---
const LEGAL_TEXTS = {
  agb: `<h3>Allgemeine Geschäftsbedingungen (AGB)</h3><p><strong>Einzelunternehmen:</strong> Christoph Zehentbauer eU<br/><strong>Inhaber:</strong> Christoph Zehentbauer</p><h4>1. Geltungsbereich</h4><p>Diese AGB gelten für sämtliche Dienstleistungen von Christoph Zehentbauer eU, einschließlich Krafttraining, Boxtraining, Lauftraining sowie aller Einzelcoachings, Gruppentrainings, 10er-Blöcke und Monatsabonnements.</p><h4>2. Vertragsabschluss</h4><p>Ein Vertrag kommt durch Buchung und Bestätigung zustande. Mit der Anmeldung erkennt der Kunde diese AGB verbindlich an.</p><h4>3. Leistungsumfang</h4><p>Der Leistungsumfang ergibt sich aus der jeweiligen Buchung.</p><h4>4. Zahlungsbedingungen</h4><p>Die Preise werden vor Vertragsabschluss bekanntgegeben.</p><h4>5. Absage, Stornierung, Nichterscheinen</h4><p>Einzeltermine können bis 24 Stunden vorher abgesagt werden.</p><h4>6. Gesundheit, Risiko und Eigenverantwortung</h4><p>(1) Die Teilnahme am Training erfolgt ausschließlich auf eigenes Risiko und in eigener Verantwortung des Kunden.</p><h4>7. Haftung</h4><p>(1) Christoph Zehentbauer eU haftet ausschließlich bei Vorsatz.</p><h4>8. Minderjährige</h4><p>Die Teilnahme Minderjähriger erfolgt nur mit schriftlicher Einwilligung der Erziehungsberechtigten.</p><h4>9. Datenschutz</h4><p>Personenbezogene Daten werden ausschließlich zum Zweck der Durchführung der Trainingsdienstleistung verarbeitet.</p><h4>10. Foto- und Videoaufnahmen</h4><p>Aufnahmen von Kunden dürfen nur mit deren ausdrücklicher Zustimmung verwendet oder veröffentlicht werden.</p><h4>11. Vertragslaufzeit bei Abonnements</h4><p>Abos laufen jeweils einen Monat und verlängern sich automatisch.</p><h4>12. Trainingsdurchführung und Änderungen</h4><p>Trainingsinhalte, -zeiten und -orte können aus organisatorischen Gründen geändert werden.</p><h4>13. Höhere Gewalt und Ausfälle</h4><p>Bei Ausfällen durch Krankheit, behördliche Anordnung, Wetterbedingungen besteht kein Anspruch auf Rückerstattung.</p><h4>14. Schlussbestimmungen</h4><p>Es gilt ausschließlich österreichisches Recht.</p>`,
  
  impressum: `<h3>Impressum</h3><p><strong>Christoph Zehentbauer e.U.</strong></p><p>Erstellung von Trainingskonzepten für gesundheitsbewusste Personen<br/>Reglementierte Tätigkeit gemäß Gewerbeordnung: Fitnesstrainer</p><p>Mitglied der Wirtschaftskammer Österreich</p><p><strong>Inhaber:</strong> Christoph Zehentbauer<br/><strong>Anschrift:</strong> Schießstätte 14, 3580 Horn, Österreich<br/><strong>Telefon:</strong> +43 664 885 99 040<br/><strong>E-Mail:</strong> ChristophZehentbauer@gmail.com<br/><strong>Steuernummer:</strong> 23201/9901<br/><strong>Unternehmensform:</strong> Eingetragenes Einzelunternehmen (e.U.)</p><h4>Haftungsausschluss</h4><p>Alle Inhalte dienen ausschließlich Informationszwecken.</p><h4>Urheberrecht</h4><p>Alle Inhalte, Texte, Fotos und Grafiken dieser Webseite unterliegen dem Urheberrecht.</p>`,
  
  datenschutz: `<h3>Datenschutzerklärung</h3><p>Der Schutz Ihrer persönlichen Daten ist uns ein besonderes Anliegen.</p><h4>1. Verantwortlicher</h4><p><strong>Christoph Zehentbauer e.U.</strong><br/>Schießstätte 14<br/>3580 Horn, Österreich<br/>Telefon: +43 664 885 99 040<br/>E-Mail: christophzehentbauer@gmail.com</p><h4>2. Erfassung und Verarbeitung personenbezogener Daten</h4><p>Wir verarbeiten jene personenbezogenen Daten, die Sie uns freiwillig im Rahmen einer Kontaktaufnahme zur Verfügung stellen.</p><h4>3. Rechtsgrundlagen der Verarbeitung</h4><p>Die Verarbeitung erfolgt auf Basis der DSGVO.</p><h4>4. Speicherdauer</h4><p>Personenbezogene Daten werden nur so lange gespeichert, wie dies zur Erfüllung der Zwecke erforderlich ist.</p><h4>5. Weitergabe von Daten</h4><p>Eine Weitergabe an Dritte erfolgt ausschließlich bei gesetzlicher Notwendigkeit.</p><h4>6. Datensicherheit</h4><p>Wir treffen angemessene technische und organisatorische Maßnahmen.</p><h4>7. Zugriffsdaten / Server-Logs</h4><p>Beim Besuch dieser Website werden automatisch technische Daten gespeichert.</p><h4>8. Cookies</h4><p>Diese Website kann Cookies verwenden, um die Funktionalität zu verbessern.</p><h4>9. Kontaktaufnahme & Terminvereinbarung</h4><p>Bei Kontaktaufnahme werden personenbezogene Daten ausschließlich zur Bearbeitung der Anfrage verarbeitet.</p><h4>10. WhatsApp-Datenschutzhinweis</h4><p>Die Kontaktaufnahme über WhatsApp erfolgt freiwillig.</p><h4>11. Social-Media-Hinweis</h4><p>Beim Anklicken von Links zu Social-Media-Plattformen verlassen Sie unsere Website.</p><h4>12. Fotos, Videos & Leistungsdaten im Training</h4><p>Vor einer eventuellen Veröffentlichung von Fotos erfolgt eine ausdrückliche Einwilligung.</p><h4>13. Keine medizinische Beratung</h4><p>Im Rahmen der Kommunikation werden keine medizinischen Diagnosen gegeben.</p><h4>14. Rechte der betroffenen Personen</h4><p>Sie haben jederzeit das Recht auf Auskunft, Berichtigung, Löschung, etc.</p>`
};
...
const GLOBAL_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .modal-overlay { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.9); z-index: 2000; display: flex; justify-content: center; align-items: center; padding: 20px; }
...
// --- EINFACHE ICON-KOMPONENTEN (ohne TypeScript) ---
...
// --- SmartImage Komponente ---
const SmartImage = ({ id, alt, className, style }) => {
    ...
    <>
      <nav className="nav-fixed">
        <div className="container flex justify-between items-center">
          ...
          <div className="mobile-hide flex gap-8 items-center">
            ...
            {['Training', 'Preise', 'Kontakt'].map((item) => (
      ...
      {isOpen && (
        <div style={{ position: 'fixed', inset: 0, background: 'black', zIndex: 200, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '2rem' }}>
          ...
          <a href="#warum-wir" onClick={() => setIsOpen(false)} style={{ fontSize: '2rem', fontWeight: '900', color: '#dc2626', textDecoration: 'none', textTransform: 'uppercase', fontStyle: 'italic' }}>Warum wir</a>
          {['Training', 'Preise', 'Kontakt'].map((item) => (
...
const Hero = () => {
  return (
    <section className="hero-section">
      <SmartImage id="hero" className="hero-bg" alt="Gym" />
      ...
      <div className="container">
        ...
        <div className="grid md-grid-3" style={{ gridAutoRows: '600px' }}>
          ...
          <div className="card" style={{ gridRow: 'span 2' }}>
            <SmartImage id="laufen" className="card-img" alt="Laufen" />
            <div className="card-overlay">
          ...
          <div className="card">
            <SmartImage id="boxen" className="card-img" alt="Boxen" />
            <div className="card-overlay">
...
const PricingCard = ({ title, price, period, features, popular, link }) => (
...
// --- Pricing Section ---
const Pricing = () => {
  const getWhatsAppLink = (paketName) => {
